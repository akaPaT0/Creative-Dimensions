        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mx-auto max-w px-6">
            <div className="p-8 text-center">
              ...
              <p className="text-white/75 mt-3 text-[50px]">
              ...
              <div className="mt-6 flex justify-center gap-10">
                <Link
                  href="/shop"
                  className="px-7 py-3 rounded-xl text-[30px] border border-white/20 bg-white/5 text-white text-base hover:bg-white/10 transition"
                >
                  Shop
                </Link>
                ...
                <Link
                  href="/contact"
                  className="px-7 py-3 rounded-xl text-[30px] border border-white/20 bg-white/5 text-white text-base hover:bg-white/20 transition"
                >
                  Contact
                </Link>
              </div>
