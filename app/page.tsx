...
export default function Home() {
  return (
    ...
    {/* HERO - Mobile (full screen, divider near bottom, small gap) */}
      <section className="relative z-10 lg:hidden min-h-[100svh] pb-1 pt-10">
        <div className="mx-auto max-w-7xl px-6 w-full">
          <div className="mx-auto max-w px-3 sm:px-8">
            <div className="p-8 text-center">
              <HeroIn>
                <div className="min-h-[calc(100svh-8rem)] flex flex-col">
                  ...
                  {/* Divider pinned near bottom (controls the gap) */}
                  <div className="relative z-10 flex justify-center  pt-0 pb-10">
      ...
      <section className="relative z-10 py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-3 text-white/70 text-base sm:text-lg pt-5">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center pt-10 gap-4">
            <Link
              href="/contact"
