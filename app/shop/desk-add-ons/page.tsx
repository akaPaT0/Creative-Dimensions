  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-28 pb-16">
        ...
        <div className="mt-8">
          <h1 className="text-4xl font-semibold text-white">Desk Add-Ons</h1>
          <p className="mt-2 text-white/70">Browse our desk add-ons.</p>
        </div>

        <CategoryProductsClient products={list} category="desk-add-ons" />
        <Footer />
      </main>
    </div>
  );
